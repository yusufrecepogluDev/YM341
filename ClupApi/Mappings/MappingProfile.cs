    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Club, ClubResponseDto>()
                ...
                .ForMember(dest => dest.AnnouncementCount, opt => opt.MapFrom(src => src.Announcements.Count(an => an.IsActive)));
            ...
            CreateMap<ClubMembership, ClubMembershipResponseDto>()
                ...
                .ForMember(dest => dest.StudentEmail, opt => opt.MapFrom(src => src.Student.StudentMail))
                .ForMember(dest => dest.ClubName, opt => opt.MapFrom(src => src.Club.ClubName));

            CreateMap<ClubMembershipApplyDto, ClubMembership>()
                .ForMember(dest => dest.JoinDate, opt => opt.MapFrom(src => DateTime.UtcNow))
                .ForMember(dest => dest.IsApproved, opt => opt.MapFrom(src => (bool?)null)) // Beklemede
                .ForMember(dest => dest.MembershipID, opt => opt.Ignore())
                .ForMember(dest => dest.StudentID, opt => opt.Ignore()) // Controller'da set edilecek
                .ForMember(dest => dest.Club, opt => opt.Ignore())
            ...
            CreateMap<ActivityParticipation, ActivityParticipationResponseDto>()
                ...
                .ForMember(dest => dest.ActivityStartDate, opt => opt.MapFrom(src => src.Activity.StartDate))
